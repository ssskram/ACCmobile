    ...
    public render() {
        ...
        <div className="form-group">
            <div className="col-md-12 form-element">
                ...
                <textarea className={conditionalClass} name={this.props.name} id={this.props.name} placeholder={this.props.placeholder} rows={4} onChange={this.props.callback.bind(this)}></textarea>
            </div>
        </div>
        )
    }
