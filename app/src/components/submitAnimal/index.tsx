...
export class Animal extends React.Component<any, state> {
  ...
  componentDidMount() {
    ...
    if (!dropdownsLoaded(this.props)) {
      this.setDropdowns(this.props.dropdowns);
    }
  }

  componentWillReceiveProps(nextProps) {
    if (!dropdownsLoaded(nextProps)) {
      this.setDropdowns(nextProps.dropdowns);
    }
  }
  ...
  setDropdowns(dropdowns) {
    ...
    dropdowns.animalBreeds.forEach(function(element) {
      var json = {
        value: element.breed,
        label: element.breed,
        type: element.type,
    ...
    dropdowns.animalCoats.forEach(function(element) {
      var json = {
        value: element.coat,
        label: element.coat,
        type: element.type,
    ...
    dropdowns.veterinarians.forEach(function(element) {
        ...
        <div className="row">
          <div className="col-md-6">
            <Select
              ...
              header="Breed"
              placeholder="Breed(s)"
              onChange={animalBreed =>
                this.setState({ animalBreed: update(animalBreed) })
              }
              multi={true}
          ...
          <div className="col-md-6">
            <Select
              ...
              placeholder="Coat(s)"
              onChange={animalCoat =>
                this.setState({ animalCoat: update(animalCoat) })
              }
              multi={true}
              options={coatOptions}
            />
        ...
        <div className="row">
          ...
          <div className="col-md-3">
            <Datepicker
              ...
              callback={date =>
                this.setState({ RabbiesVacExp: date.target.value })
              }
            />
          </div>
        </div>
